...
ym.modules.define('form-view', [
  ...
  var FormView = defineClass(function () {
    ...
    var form = this._form = document.querySelector('form');
    this._controls = form.querySelectorAll('.control-group');
    this._message = form.querySelectorAll('.help-inline');
    ...
    _setupListeners: function () {
      this._form
        .addEventListener('submit', bind(this._onFormSubmit, this));
...
ym.modules.define('suggest-view', [
  ...
  var SuggestView = defineClass(function (options) {
    ...
    this._input = document.querySelector('.search-query');
    this._options = extend({}, defaultOptions, options);
    this._setupListeners();
  }, {
    _setupListeners: function () {
      ...
      this._input
        .addEventListener('keydown', bind(this._onQueryChange, this))
        .typeahead(extend({
